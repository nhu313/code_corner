...
CodeCorner.Repo.insert!(%CodeCorner.Class.Quiz{id: 1, name: "Pre Quiz", slug: "pre_quiz"})
...
CodeCorner.Repo.insert!(%CodeCorner.Class.Quiz{id: 2, name: "Post Quiz", slug: "post_quiz"})
